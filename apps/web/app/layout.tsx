...
export const metadata: Metadata = {
  title: {
    default: 'LetterSKull',
    template: 'A Skull from your Letter',
  },
  description:
  ...
  metadataBase: new URL('https://letterskull.vercel.app'),
  alternates: {
    canonical: '/',
  },
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://letterskull.vercel.app',
    title: 'A Skull from your Letter',
    description:
      'A modern & minimal web3 starter kit for building decentralized applications with Next.js, Wagmi, and Shape Network. Get quickly started onchain with sensible defaults for a great user & developer experience.',
    siteName: 'LetterSkull',
  },
  twitter: {
          ...
          <div className="bg-background min-h-screen font-[family-name:var(--font-geist-sans)]">
            ...
            <footer className="border-t py-6 md:py-0">
              <div className="container mx-auto flex items-center justify-between gap-4 px-4 sm:h-16">
                <Link
                  href="https://shapescan.xyz/address/0x75A9bd203aFbB4D8FB233372d1D9Ea30E0F1Adfd"
                  target="_blank"
                  rel="noreferrer"
                ...
                <Link
                  href="https://opensea.io/collection/letterskull"
                  target="_blank"
                  rel="noreferrer"
                  className="text-muted-foreground text-left text-sm leading-loose hover:underline"
                >
